...
import { BsHeart ,  BsFillCircleFill , BsArrowLeftRight , BsLock , BsChevronCompactDown , BsSearch} from "react-icons/bs";
...
export default function BoxesArrivals() {
                            ...
                            {isShown && (
                                <div className="hoverdCard   position-absolute">
                                  ...
                                  <div className="bb d-flex flex-column flex-wrap py-4 mt-4  ml-4">
                                       <div className="text-white"> New look mens coat </div>
                                       <div className="border rounded text-white px-1" style={{width:"75px"}} >Fashion</div>
                                        <div  style={{textDecoration: "line-through" ,color:"white"}}>€220-00</div>
                            ...
                            {isShown && (
                                <div className="hoverdCard   position-absolute">
                                  ...
                                  <div className="bb d-flex flex-column  flex-wrap py-4 mt-4 ml-4">
                                       <div className="text-white"> New look mens coat </div>
                                       <div className="border rounded px-1" style={{width:"75px"}} >Fashion</div>
                                        <div className="text-white" style={{ textdecoration: "line-through"}}>€220-00</div>
                                        <div className="color">€190.00</div>
                                  </div>
